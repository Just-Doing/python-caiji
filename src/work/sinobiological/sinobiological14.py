...
excelFileName="sinobiological14.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/il12-signaling-pathway", "IL-12 Family Signaling Pathways", products)
