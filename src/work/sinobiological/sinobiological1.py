...
excelFileName="sinobiological1.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/actin-dynamics-signaling-pathway", 'Actin Dynamics Signaling Pathways', products)
