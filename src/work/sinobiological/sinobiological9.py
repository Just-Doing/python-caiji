...
excelFileName="sinobiological9.xlsx"
wb = Workbook()
workSheet = wb.active
products = []


getProductType2("https://www.sinobiological.com/pathways/death-receptor-pathway", "Death Receptor Signaling Pathway", products)
