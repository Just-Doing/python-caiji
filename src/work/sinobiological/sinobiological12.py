...
excelFileName="sinobiological12.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/il1-signaling-pathway","IL-1 Family Signaling Pathways" , products)
