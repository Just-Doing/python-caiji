...
excelFileName="sinobiological6.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/canonical-wnt-pathway", 'Canonical Wnt Signaling Pathway', products)
