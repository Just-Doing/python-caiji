...
excelFileName="sinobiological5.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/b-cell-receptor-signaling-pathway", 'B Cell Receptor Signaling Pathway', products)
