...
excelFileName="sinobiological15.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/il17-signaling-pathway", "IL-17 Family Signaling Pathway", products)
