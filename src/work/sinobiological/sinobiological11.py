...
excelFileName="sinobiological11.xlsx"
wb = Workbook()
workSheet = wb.active
products = []
# getProductInfo('https://www.sinobiological.com/cdna-clone/human-14-3-3-beta-hg10843-m', {}, products)

getProductType2("https://www.sinobiological.com/pathways/g-protein-coupled-receptors-pathway", "G Protein Coupled Receptor Signaling Pathway", products)
