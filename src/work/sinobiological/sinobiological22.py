...
def getProductType2(url, type, products):
	...
	for img in typeImages:
		...
		if currentType != provType:
			...
			type3Area = sope.find(name="div",attrs={"id":"popup"+str(imgIndex)})
			if type3Area != None:
...
excelFileName="sinobiological22.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/p53-pathway", "p53 Pathway", products)
