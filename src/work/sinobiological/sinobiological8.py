...
excelFileName="sinobiological8.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/complement-activation-pathways", "Complement Activation Pathways", products)
