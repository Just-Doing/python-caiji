...
excelFileName="sinobiological21.xlsx"
wb = Workbook()
workSheet = wb.active
products = []


getProductType2("https://www.sinobiological.com/pathways/p38-mapk-signaling-pathway", "P38 MAPK Signaling Pathway", products)
