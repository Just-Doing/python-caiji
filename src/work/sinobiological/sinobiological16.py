...
excelFileName="sinobiological16.xlsx"
wb = Workbook()
workSheet = wb.active
products = []


getProductType2("https://www.sinobiological.com/pathways/jak-stat-signaling-pathway", "Jak-Stat Signaling Pathway", products)
