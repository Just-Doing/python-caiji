...
excelFileName="sinobiological23.xlsx"
wb = Workbook()
workSheet = wb.active
products = []

getProductType2("https://www.sinobiological.com/pathways/t-cell-receptor-signaling-pathway", "T Cell Receptor Signaling Pathway", products)
