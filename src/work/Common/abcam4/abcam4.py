...
for pIndex in range(1,21):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Immunology--Innate%20Immunity--Chemokines&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','Chemokines')

for pIndex in range(1,3):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Cellular%20and%20biochemical%20assays&selected.researchAreas=Immunology--Innate%20Immunity--Macrophage%20%2F%20Inflamm.&pagenumber='+str(pIndex),'Cellular and biochemical assays','Macrophage / Inflamm.')
for pIndex in range(1,28):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Immunology--Innate%20Immunity--Macrophage%20%2F%20Inflamm.&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','Macrophage / Inflamm.')

getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Multiplex%20Assays&selected.researchAreas=Immunology--Innate%20Immunity--Macrophage%20%2F%20Inflamm.&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','')

for pIndex in range(1,10):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Immunology--Innate%20Immunity--TLR%20Signaling&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','TLR Signaling')

getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Cellular%20and%20biochemical%20assays&selected.researchAreas=Immunology--Innate%20Immunity--TLR%20Signaling&pagenumber='+str(pIndex),'Cellular and biochemical assays','TLR Signaling')

for pIndex in range(1,18):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Immunology--Cell%20Type%20Markers&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','Cell Type Markers')

getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Cellular%20and%20biochemical%20assays&selected.researchAreas=Immunology--Cell%20Type%20Markers&pagenumber='+str(pIndex),'Cellular and biochemical assays','Cell Type Markers')

for pIndex in range(1,9):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Immunology--Secreted%20Molecules&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','Secreted Molecules')

for pIndex in range(1,4):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Cellular%20and%20biochemical%20assays&selected.researchAreas=Metabolism--Pathways%20and%20Processes--Redox%20metabolism&pagenumber='+str(pIndex),'Cellular and biochemical assays','Redox metabolism')

for pIndex in range(1,13):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=ELISA%20and%20Matched%20Antibody%20Pair%20Kits&selected.researchAreas=Metabolism--Pathways%20and%20Processes--Redox%20metabolism&pagenumber='+str(pIndex),'ELISA and Matched Antibody Pair Kits','Redox metabolism')
...
excelUtils.generateExcelMultipleSheet('abcam4.xlsx', [
	{
		"name": 'abcam4',
