...
headers1=['link','nav', 'Product type1','Product type2','cat','Product Name','Application:','Active:','Expression system:','Protein length:','Tag:','Reactivity:','Conjugate:','image','Product size',
...
for pIndex in range(1,23):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&keywords=Cytokine&selected.classification=Proteins%20and%20Peptides&pagenumber='+str(pIndex),'Proteins and Peptides','')
for pIndex in range(1,13):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Proteins%20and%20Peptides&selected.researchAreas=Immunology--Innate%20Immunity--Chemokines&pagenumber='+str(pIndex),'Proteins and Peptides','Chemokines')
for pIndex in range(1,21):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Proteins%20and%20Peptides&selected.researchAreas=Immunology--Innate%20Immunity--Macrophage%20%2F%20Inflamm.&pagenumber='+str(pIndex),'Proteins and Peptides','Macrophage / Inflamm.')

for pIndex in range(1,10):
	getProductList('https://www.abcam.com/products/loadmore?sortOptions=Relevance&selected.classification=Proteins%20and%20Peptides&selected.researchAreas=Immunology--Innate%20Immunity--TLR%20Signaling&pagenumber='+str(pIndex),'Proteins and Peptides','TLR Signaling')
...
excelUtils.generateExcelMultipleSheet('abcam2.xlsx', [
	{
		"name": 'abcam2',
		"header": headers1 ,
		"data": products1
