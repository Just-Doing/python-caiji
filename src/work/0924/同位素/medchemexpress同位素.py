...
headers = [
    'link', 'nav', 'cat', 'Product Name', '体外研究(In Vitro)', 'description', 'size', '生物活性','IC50 & Target', 'Formula','分子量', 'CAS 号', '结构分类','来源','运输条件', '储存方式', 
    'Solvent & Solubility'
]

excelFname = "medchemexpress同位素.xlsx"
products = []

getProductList("https://www.medchemexpress.com/search.html?q=diabetes&ft=&fa=&fp=&fsp=&ftag=&fsc=&type=isotope-labeled-compounds", products)
