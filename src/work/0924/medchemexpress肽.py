...
headers = [
    'link', 'nav', 'cat', 'Product Name', 'target', 'research', 'description', 'size', '生物活性','IC50 & Target', 'Formula', 'CAS 号','Sequence','Sequence Shortening', '运输条件', '储存方式', 
    'Solvent & Solubility'
]

excelFname = "medchemexpress肽.xlsx"
products = []

getProductList("https://www.medchemexpress.com/search.html?q=diabetes&ft=&fa=&fp=&fsp=&ftag=&fsc=&type=peptides", products)
