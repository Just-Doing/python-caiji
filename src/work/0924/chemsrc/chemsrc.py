...
def getProductInfo(url, type, products, browser):
    print(str(len(products))+":"+url)
    sope = getRenderdHtmlFromUrl(browser, url)
    pInfo = {
    ...
    spectrunmUrlSope = getRenderdHtmlFromUrl(browser, spectrunmUrl)
    spectrunmDetailtrs = spectrunmUrlSope.find_all("tr")
...
def getProductList(url, type, products, browser):
    sope = getRenderdHtmlFromUrl(browser, url)
    resAreas = sope.find_all("div", attrs={"class": "media search-media"})
    print(url + ":总共"+str(len(resAreas)))
    for resArea in resAreas:
        pLink = resArea.find("a")
        if pLink != None:
            getProductInfo("https://www.chemsrc.com"+pLink["href"], type, products, browser)
...
excelFname = "chemsrc5.xlsx"
products = []

# getProductInfo("https://www.chemsrc.com/en/cas/548-29-8_1057878.html",'Lignans', products)
# for pIndex in range(1, 8):
#     getProductList("https://www.chemsrc.com/en/Catg/964.html?page="+str(pIndex),'Lignans', products, browser)
# for pIndex in range(1, 3):
#     getProductList("https://www.chemsrc.com/en/Catg/965.html?page="+str(pIndex),'Xanthone', products, browser)
# for pIndex in range(1, 10):
#     getProductList("https://www.chemsrc.com/en/Catg/966.html?page="+str(pIndex),'Flavonoids', products, browser)
# for pIndex in range(10, 16):
#     getProductList("https://www.chemsrc.com/en/Catg/966.html?page="+str(pIndex),'Flavonoids', products, browser)
# for pIndex in range(1, 28):
#     getProductList("https://www.chemsrc.com/en/Catg/967.html?page="+str(pIndex),'Moss', products, browser)
# for pIndex in range(1, 5):
#     getProductList("https://www.chemsrc.com/en/Catg/968.html?page="+str(pIndex),'Iridoid derivative', products, browser)
# for pIndex in range(1, 6):
#     getProductList("https://www.chemsrc.com/en/Catg/969.html?page="+str(pIndex),'Coumarin', products, browser)
# for pIndex in range(1, 13):
#     getProductList("https://www.chemsrc.com/en/Catg/970.html?page="+str(pIndex),'Phenols', products, browser)
for pIndex in range(1, 5):
    getProductList("https://www.chemsrc.com/en/Catg/971.html?page="+str(pIndex),'Steroidal compound', products, browser)
for pIndex in range(1, 4):
    getProductList("https://www.chemsrc.com/en/Catg/972.html?page="+str(pIndex),'Phenylpropanoid', products, browser)
for pIndex in range(1, 2):
    getProductList("https://www.chemsrc.com/en/Catg/973.html?page="+str(pIndex),'Anthraquinone', products, browser)
for pIndex in range(1, 3):
    getProductList("https://www.chemsrc.com/en/Catg/974.html?page="+str(pIndex),'Chalcone', products, browser)
for pIndex in range(1, 9):
    getProductList("https://www.chemsrc.com/en/Catg/977.html?page="+str(pIndex),'Sesquiter', products, browser)
for pIndex in range(1, 18):
    getProductList("https://www.chemsrc.com/en/Catg/975.html?page="+str(pIndex),'Alkaloid', products, browser)
