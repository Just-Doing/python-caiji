...
excelFileName="atcc2.xlsx"
wb = Workbook()
workSheet = wb.active
products = []
# getProductInfo("https://www.atcc.org/products/all/53545.aspx" ,products)
for pageIndex in range(0, 50):
	aq='(@productlineclassification=="Fungi & Yeast") (@syssource==("Coveo_liveweb_index - production","ATCC-PROD") ((@syssource=="ATCC-PROD")) NOT @ftemplateid14674==("adb6ca4f-03ef-4f47-b9ac-9ce2ba53ff97","fe5dd826-48c6-436d-b87a-7c4210c7413b"))'
	q=''
	getProductList(aq, q, pageIndex * 100 ,products)


headers=['nub','title',
		'Deposited As','Strain Designations','Application',
		'Biosafety Level','Product Format','Storage Conditions',
		'Type Strain','Medium','Growth Conditions','Cross References',
		'Disclosure','U.S. Patent Number',
		'Isolation','Genotype','Subcultivation','Genome Sequenced Strain',
		'Classification','Morphology','Sequenced Data','Ploidy','Alternate State',
		'Mating Type','Viability','Intended Use'
	]
rindex = 1
for p in products:
