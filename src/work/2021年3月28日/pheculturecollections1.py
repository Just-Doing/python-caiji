...
def getProductList(letter, type, url, pageIndex, products):
	...
	for tr in trs+trs1:
		...
		getProductInfo(letter, type, "https://www.phe-culturecollections.org.uk/products/fungi/detail.jsp?"+linkUrl[1], products)
		
def getProductType(q, products):
	url = "https://www.phe-culturecollections.org.uk/products/fungi/browse.jsp"
	d = {
		'a2z': q
	}
	...
	for tr in tabarea.find_all("tr"):
		link = tr.find("a")
		if link!=None:
			getProductList(q, getNodeText(link), "https://www.phe-culturecollections.org.uk/products/fungi/browse.jsp"+link["href"], 1, products)
		
excelFileName="pheculturecollections1.xlsx"
wb = Workbook()
workSheet = wb.active
products = []
# getProductType("A" ,products)
...
headers=['url','letter',"type","NCPF No.:","Source:","Site of Origin:","Clinical details:","DNA Available:",
"Species Name Anamorph:","Other Collections No:","Hazard Group (ACDP):",
"Synonyms:","Specific Remarks:","General Remarks:","availableFormats","Species Name Teleomorph:","Clinical details:",
"Other Collections No:","Sub-specific Division:"
	]
rindex = 1
for p in products:
