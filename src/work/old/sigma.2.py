...
excelFileName="sigma2.xlsx"
wb = Workbook()
workSheet = wb.active
products = []
url = "https://www.sigmaaldrich.com/materials-science/material-science-products.html?TablePage=16371327"
getProductSope( url, {}, 0, products)

# productListHtml = getHtmlFromUrl("https://www.sigmaaldrich.com/materials-science/material-science-products.html?TablePage=113876377")
# sope = BeautifulSoup(productListHtml, "html.parser",from_encoding="utf-8")
# getProductInfo(workSheet,sope, {'t1':'t1','t2':'t2','t3':'t3'})
headers=["t1",'t2','t3','name','Synonym','RelatedCategories','assay','form','concentration','refractiveindex','bp','storagetemp','Application','Packaging',
