...
for pIndex in range(1, 19):
	getProductList("https://www.mybiosource.com/search/Caenorhabditis+Elegans+Protein?type=Recombinant+Protein&size=200&page="+str(pIndex))
# getProductList("https://www.mybiosource.com/search/Caenorhabditis+Elegans+Protein?type=Recombinant+Protein&size=200&page=1")

# getProductList("https://www.mybiosource.com/search/Caenorhabditis+Elegans?type=Antibody&size=200&page="+str(1))
# getProductInfo("https://www.mybiosource.com/monoclonal-arabidopsis-arabidopsis-thaliana-drosophila-drosophila-melanogaster-fruit-fly-human-mammal-melanogaster-xenopus-antibody/histone-h4/375131")

headers=['link', 'nav', 'Product Name', 'Catalog #','Full Product Name','Product Synonym Names','Product Gene Name','Product Synonym Gene Name',
	 'Sequence Positions','Sequence','Chromosome Location','3D Structure','Host','Purity/Purification'
	 ,'Form/Format','Tag Information','Sterility','Endotoxin','Species','Preparation and Storage','ISO Certification',
	 'Other Notes','NCBI GeneID','Molecular Weight','NCBI Official Symbol'
	 ]


excelUtils.generateExcelMultipleSheet('mybiosource-Protein.xlsx', [
	{
		"name":"mybiosource",
