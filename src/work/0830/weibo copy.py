...
browser.add_cookie({'domain': '.weibo.com', 'httpOnly': False, 'name': 'SUB', 'path': '/', 'sameSite': 'None', 'secure': True, 'value': '_2A25OQrNVDeRhGeBO61YT-C7JyDyIHXVtOaOdrDV_PUNbm9AKLWWkkW9NSlmktJ8lQvfGlqnC_JElA1FyzSeL6UEn'})
...
browser.add_cookie({'domain': '.weibo.com', 'httpOnly': False, 'name': 'webim_unReadCount', 'path': '/', 'sameSite': 'None', 'secure': True, 'value': '%7B%22time%22%3A1665583026438%2C%22dm_pub_total%22%3A4%2C%22chat_group_client%22%3A0%2C%22chat_group_notice%22%3A0%2C%22allcountNum%22%3A46%2C%22msgbox%22%3A0%7D'})
...
browser.add_cookie({'domain': '.weibo.com', 'httpOnly': False, 'name': 'SCF', 'path': '/', 'sameSite': 'None', 'secure': True, 'value': 'AjUvWuiha4N_hVf6kE9Shy6oTw93Q8gi5jAiLCjseMCxMbcOAqRYpOQIkh5QDMPaqCKKXrDrV2G-XYTCp_Vqjsg.'})
