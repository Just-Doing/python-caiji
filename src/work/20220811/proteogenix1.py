...
def getProductInfo(url, products):
	...
	if productNameArea!=None:
		...
		if datasheetLink!= None:
			fileName = re.sub(u"([^\u4e00-\u9fa5\u0030-\u0039\u0041-\u005a\u0061-\u007a])","", pInfo["productName"])
			urllib_download(datasheetLink["href"], fileName+".pdf")
...
headers=[
	'link','productName','nav','Size','size0','price0','Reference0','size1','price1','Reference1','size2','price2','Reference2','size3','price3','Reference3','Reference'
	,'Brand','Product type','Product name','Delivery condition','Delivery lead time in business days','Storage condition','Applications',
	'Composition','Advantages','Alternatives','Related Products','Publications','PublicationsLink','img0','img1','img2'
]

excelFname="proteogenix1.xlsx"
products = []
getProductInfo('https://www.proteogenix.science/product/lymphoprep/', products)
getProductInfo('https://www.proteogenix.science/product/lymphoprep-tube/', products)
getProductInfo('https://www.proteogenix.science/product/nycodenz-ag/', products)
getProductInfo('https://www.proteogenix.science/product/optiprep/', products)
getProductInfo('https://www.proteogenix.science/product/polymorphprep/', products)
# for pIndex in range(1, 20)
# 	getProductList("https://www.proteogenix.science/?wpgb-ajax=refresh&_per_page=100&_page=2", products)
